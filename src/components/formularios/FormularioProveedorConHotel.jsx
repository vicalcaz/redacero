/* filepath: c:\Users\Public\RedAcero\redacero-eventos\src\components\formularios\FormularioProveedorConHotel.jsx */
import { useState } from 'react';
import './FormularioBase.css';

function FormularioProveedorConHotel() {
  ...
  const [personas, setPersonas] = useState([{
    ...
    // Campos específicos para proveedor con hotel
  ...
  return (
    <div className="formulario-proveedor-con-hotel">
      <h3>Formulario para Proveedores con Hotel</h3>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {personas.map((persona, index) => (
          <div key={persona.id} className="seccion datos-persona">
            ...
            <div className="subseccion hotel-info">
              <h5>Información de Hotel</h5>
              <div className="form-grid">
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input
                    type="number"
                    min="1"
                    value={persona.noches}
                    onChange={(e) => actualizarPersona(persona.id, 'noches', parseInt(e.target.value))}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    type="number"
                    min="0"
                    value={persona.acompanantes}
                    onChange={(e) => actualizarPersona(persona.id, 'acompanantes', parseInt(e.target.value))}
                  />
                </div>
              </div>
            </div>
        ...
        <div className="seccion comentarios">
          ...
          <textarea
            ...
            placeholder="Los proveedores con hotel incluyen alojamiento. Especificar cualquier requerimiento especial..."
            rows="4"
          />
        </div>
