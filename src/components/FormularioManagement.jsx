...
function FormularioManagement({ user }) {
  ...
  const renderVista = () => {
    switch (vistaActiva) {
      case 'socio':
        return <FormularioSocio user={user} />;  // Pasar user
      case 'proveedor-con-hotel':
        return <FormularioProveedorConHotel user={user} />;  // Pasar user
      case 'proveedor-sin-hotel':
        return <FormularioProveedorSinHotel user={user} />;  // Pasar user
      case 'guardados':
        return (
